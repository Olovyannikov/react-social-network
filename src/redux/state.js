    ...
    sidebar: {
        ...
        friends: [
            ...
            },
            {
                ...
                name: 'Danya',
                lastname: 'Tolstov',
                avatar: 'https://img1.freepng.ru/20180626/ehy/kisspng-avatar-user-computer-icons-software-developer-5b327cc951ae22.8377289615300354013346.jpg'
            },
            {
                id: Math.floor(Math.random() * 100),
                name: 'Mina',
                lastname: 'Kublikova',
                avatar: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSWy4mGn2H4biENdFN-hIutdbAB9-aXVl08sXAzq_fFY4feDadOGQJH5kHBM1adSIKL2W0&usqp=CAU'
            }
        ]
    }
}
